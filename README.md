...
Its a way to individually store data that can be used to persist state information between page requests and uses cookies to authenticate user on the database. 

1. What does bcrypt do to help us store passwords in a secure manner.

it transforms the password to a hash string on the db

1. What does bcrypt do to slow down attackers?

encrypts the password and makes it much longer and "randomizes" it with a structure that takes much longer to crack.
